...
class _SelectableTextSelectionGestureDetectorBuilder extends TextSelectionGestureDetectorBuilder {
  ...
  void onTapDown(TapDownDetails details) {
    ...
    final TextEditingValue value = (delegate as _SelectableTextState)._editableText.textEditingValue;
    final w = value.selection.textInside(value.text);
    print("鼠标按下：$w：${details.globalPosition}");
  }
  ...
  void onSingleTapUp(TapUpDetails details) {
    print("鼠标抬起时触发：${details.globalPosition}");
...
class _SelectableTextState extends State<SelectableText> with AutomaticKeepAliveClientMixin implements TextSelectionGestureDetectorBuilderDelegate {
  ...
  bool _showSelectionHandles = false; // 是否显示2个拖动按钮（文本选择用）
